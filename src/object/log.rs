...
impl Logger {
    ...
    pub fn make_object(class: Arc<Class>, parent: ObjectBox<dyn Object>) -> ObjectBox<dyn Object> {
        ObjectStruct::new(class, Some(parent), 0)
    }
}



fn log_println(_: ObjectBox<dyn Object>, context: &mut ContextData) -> Result<Option<ObjectBox<dyn Object>>, Fault> {
...
fn log_print(_: ObjectBox<dyn Object>, context: &mut ContextData) -> Result<Option<ObjectBox<dyn Object>>, Fault> {
    let message = context.arguments[0].clone();
    let message = message.borrow();
    let message = message.downcast_ref::<StringObject>().ok_or(Fault::InvalidType)?;
    print!("{}", message.value);
...
fn log_eprintln(_: ObjectBox<dyn Object>, context: &mut ContextData) -> Result<Option<ObjectBox<dyn Object>>, Fault> {
    let message = context.arguments[0].clone();
    let message = message.borrow();
    let message = message.downcast_ref::<StringObject>().ok_or(Fault::InvalidType)?;
    println!("{}", message.value);
...
fn log_eprint(_: ObjectBox<dyn Object>, context: &mut ContextData) -> Result<Option<ObjectBox<dyn Object>>, Fault> {
    let message = context.arguments[0].clone();
    let message = message.borrow();
    let message = message.downcast_ref::<StringObject>().ok_or(Fault::InvalidType)?;
    print!("{}", message.value);
...
fn log_info(_: ObjectBox<dyn Object>, context: &mut ContextData) -> Result<Option<ObjectBox<dyn Object>>, Fault> {
    let message = context.arguments[0].clone();
    let message = message.borrow();
    let message = message.downcast_ref::<StringObject>().ok_or(Fault::InvalidType)?;
    info!("{}", message.value);
...
fn log_trace(_: ObjectBox<dyn Object>, context: &mut ContextData) -> Result<Option<ObjectBox<dyn Object>>, Fault> {
    let message = context.arguments[0].clone();
    let message = message.borrow();
    let message = message.downcast_ref::<StringObject>().ok_or(Fault::InvalidType)?;
    trace!("{}", message.value);
...
fn log_warn(_: ObjectBox<dyn Object>, context: &mut ContextData) -> Result<Option<ObjectBox<dyn Object>>, Fault> {
    let message = context.arguments[0].clone();
    let message = message.borrow();
    let message = message.downcast_ref::<StringObject>().ok_or(Fault::InvalidType)?;
    warn!("{}", message.value);
...
fn log_error(_: ObjectBox<dyn Object>, context: &mut ContextData) -> Result<Option<ObjectBox<dyn Object>>, Fault> {
    let message = context.arguments[0].clone();
    let message = message.borrow();
    let message = message.downcast_ref::<StringObject>().ok_or(Fault::InvalidType)?;
    error!("{}", message.value);
...
fn log_debug(_: ObjectBox<dyn Object>, context: &mut ContextData) -> Result<Option<ObjectBox<dyn Object>>, Fault> {
    let message = context.arguments[0].clone();
    let message = message.borrow();
    let message = message.downcast_ref::<StringObject>().ok_or(Fault::InvalidType)?;
    debug!("{}", message.value);
